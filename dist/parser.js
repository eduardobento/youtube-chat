...
function parseMessages(runs) {
  return runs.map((run) => {
    ...
    if ("text" in run) {
      ...
      const shortcut =
        ((_b = (_a = run.emoji) === null || _a === void 0 ? void 0 : _a.shortcuts) === null || _b === void 0
          ? void 0
          : _b.length) > 0
          ? (_c = run.emoji) === null || _c === void 0
            ? void 0
            : _c.shortcuts[0]
          : ""
      return {
...
function parseActionToChatItem(data) {
  ...
  const authorNameText =
    (_b = (_a = messageRenderer.authorName) === null || _a === void 0 ? void 0 : _a.simpleText) !== null &&
    _b !== void 0
      ? _b
      : ""
  const ret = {
